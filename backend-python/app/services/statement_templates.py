...
TEMPLATES: List[StatementTemplate] = [
    ...
    StatementTemplate(
        template_id="stellar_bank_v1",
        bank_name="Stellar Bank",
        layout_family="sectioned_deposits_withdrawals",
        parser_format="stellar_bank",
        bank_patterns=[
            "stellar bank",
            "stellar",
        ],
        ...
        amount_rules={},
        stop_keywords=[],
        sample_files=["Stellar Bank.pdf"],
    ),
    StatementTemplate(
        template_id="lake_michigan_credit_union",
        bank_name="Lake Michigan Credit Union",
        layout_family="multi_account_statement",
        parser_format="lake_michigan_credit_union",
        bank_patterns=[
        ...
        sample_files=["LMCU Bank.pdf"],
    ),
    StatementTemplate(
        template_id="mercury_bank_v1",
        bank_name="Mercury Bank",
        layout_family="daily_balance_only",
        parser_format="mercury_bank",
        bank_patterns=[
            "mercury bank",
            "mercury",
        ...
        amount_rules={},
        stop_keywords=[],
        sample_files=["Mercury Bank.pdf"],
    ),
    StatementTemplate(
        template_id="exchange_bank_comm_ckg",
        bank_name="Exchange Bank",
        layout_family="sectioned_deposits_withdrawals",
        parser_format="exchange_bank",
        bank_patterns=[
            "exchange bank",
            "comm ckg analysis hr",
            "milledgeville",
        ],
        header_keywords=[
            "exchange bank",
...
BANK_KEY_MAP: Dict[str, List[str]] = {
    ...
    "stellar":           ["stellar_bank_v1"],
    "lmcu":              ["lake_michigan_credit_union"],
